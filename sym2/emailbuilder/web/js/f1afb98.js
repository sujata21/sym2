...
//add email 
    ...
    //alert('test');
        ...
        emailname = emailname.replace(/\s+/g, '_');
     ...
     tabs.delegate( ".closeTab", "click", function() {
        ...
        $("div#tabs").tabs("refresh");
            ...
            function openTab(email , option,template){
                ...
                $("div#tabs").append('<div id="'+tabId+'"><iframe src="'+url+'" id="iframe'+option+'" width="'+width+'" height="'+height+'" name="alchemy" scrolling="yes" frameborder="0"></iframe></div>');
                $("div#tabs").tabs("refresh");
                $("div#tabs").tabs( { active: tabCount } );    
                tabCount = tabCount + 1;
