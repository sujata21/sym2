...
/*  $('.title').mouseover(function(event) {
  ...
  $('.email-title').mouseover(function(event) {
    var image = '/uploads/archive/'+$(this).text()+'.jpg';
  $( ".email-title" ).tooltip({ content: '<img src="http://icdn.pro/images/fr/a/v/avatar-barbe-brun-homme-utilisateur-icone-9665-128.png" />' });
});
        ...
        $("div#tabs").tabs("refresh");
            ...
            $.post("/email/version/"+email_title, function(data) {
                ...
                $.each(res, function(index, val) {
                    ...
                    if(index != 0)
                      ver_str = ver_str+'<li class="list-group-item">Version : '+val+' <a style="padding-left:3px;cursor:pointer"onclick="getVersion(\''+email_title+'\',\''+verName+'\',\''+type+'\')" >view</a> | <a style="padding-left:3px;cursor:pointer" onclick="restore(\''+email_title+'\',\''+verName+'\')" >Restore</a></li>';
            ...
            function getVersion(var1,verName,type){
               ...
               // verName_cnt = verName.length; 
                ...
                if(type == 'email'){
                  iframeurl = '/email/viewVersion/'+var1+'/'+verLink;
                }else{
                  iframeurl = '/archive/viewVersion/'+var1+'/'+verLink;
                }
            ...
            function archieve(email){
              ...
              if (r==true)
              {
                  ...
                  $.post('/archive/final/'+email, function(data) {
