...
class ProfileController extends Controller
{
    ...
    public function editProfileAction()
    {
        ...
        //->getRepository('ApplicationClientBundle:Profile')
        ...
        $form = $this->container->get('sonata.client.profile.form');
        
        $formHandler = $this->container->get('sonata.client.profile.form.handler');
