...
use Application\TemplateBundle\Utils\ArchieveUtils;
 ...
 */
class BBCArchive implements RouteReferrersReadInterface, PublishTimePeriodInterface, PublishableInterface
{
	/**
	...
	*/
	...
	{
		$this->title = $title;
		$this->name = ArchieveUtils::slugify($title);
		$this->slug = $this->name;
	}
	...
	{
		if(!isset($this->slug)){
			$this->slug = ArchieveUtils::slugify($this->title);
		}
		return $this->slug;
	}
