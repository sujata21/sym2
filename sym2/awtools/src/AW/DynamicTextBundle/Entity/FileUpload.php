...
class FileUpload
{
    ...
    {
    	$this->resultImage1 = $resultImagee1;
    ...
    public function preUpload()
    {
    	...
    	if (null !== $this->file) {
    		...
    		$this->resultImage1 = 'res1-'.$this->getSourceImage();
    	}
    ...
    public function upload()
    {
    	...
    	copy($this->getUploadRootDir() .'/'. $this->sourceImage, $this->getUploadRootDir() .'/'. $this->resultImage1);
