 ...
 */
class Version20140115093804 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql("CREATE TABLE hd_article_category (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB");
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql("DROP TABLE hd_article_category");
